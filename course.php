				...
				<div class="row">
					<div class="col">
						<ul class="breadcrumbs_list d-flex flex-row align-items-center justify-content-start">
							...
							<li><a href="courses.php">spanish</a></li>
							<li>vocabulary</li>
						</ul>
					</div>
				</div>
					...
					<div class="intro_container d-flex flex-column align-items-start justify-content-end">
						<div class="intro_content">
							...
							<div class="intro_meta">
								...
								<div class="intro_instructors"><a href="instructors.php">Aashu Yadav</a> and <span><a href="instructors.php">5 other instructors</a></span></div>
							</div>
						</div>
					</div>
				</div>
