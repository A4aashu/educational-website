...
<div class="super_container">
			...
			<div class="container">
				<div class="row">
					<div class="col text-center">
						...
						<h1 class="home_title"><span class="change-content"></span> </h1>
	...
	<div class="courses">
		...
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="section_title text-center">Popular Courses</h2>
				</div>
			</div>
							...
							<div class="flip-card">
										<div class="flip-card-inner">
										  <div class="flip-card-front">
												<img src="images/course_1.jpg" alt="" style="height: 100%">
										  </div> 
										  <div class="flip-card-back"> 
											...
											<div class="back">
											  <h2>Vocabulary</h2>
											  <p>Individual begins to learn after his birth and goes on learning till death. He learns through living and tries to adapt himself to the environment around him. </p>
											  <p><i class="fa fa-dollar"></i> 2300</p>
											  <div>
													<ul>
															<li><a href="instructor_single.php">Teached by-:Aashu Yadav</a></li>
															
													</ul>
											  </div>
											  <a href="course.php" id="button" class="button">Get This Course</a>
			...
			<div class="row instructors_row">
				...
				<div class="col-lg-4 instructor_col">
					<div class="instructor text-center">
						...
						<div class="instructor_name"><a href="instructor_single.php">Aashu Yadav</a></div>
			...
			<div class="row">
				...
				<div class="register_timer_container">
						...
						<div class="register_timer_text">
							<img src="images\instructor_1.jpg" alt="" style=" border-radius: 50%">
						</div>
						<div class="register_timer_title">Next Course Starting</div>
				...
				<div class="col-lg-6">
				<div class="register_form_container" style="height: 400px">
						<div class="register_form_title">Register Now</div>
				...
				<div class="col-lg-4 event_col">
					<div class="event">
							...
							<div class="containerz">
									...
									<p class="titlez">Networking day</p>
									<div class="overlayz"></div>
									<div class="buttonz"><a href="reg_event.php"> JOIN </a></div>
								  </div>
	...
	<div class="container1" style="width:100%">
			<img id="aashu" src="images/pp.jpg" alt="test" style="height: 800px" >
			<div class="center">
			 <h1 style=" font-weight: bold;
			 color: #000;
			 font-size: 70px;
			 font-family:serif;text-shadow: 4px 4px 5px red;">Take Our Free Learning Test</h1> 
			 <h2  style=" font-weight: italic;
			 color: #000;
			 font-family: cursive">
			This quick and free online test will tell your language level.
		   
		  </h2>
			 </div>
			
			 <div class="center2">
			<button class="ripple" >Start Now!</button>
