	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="instructor_single.php">Instructors</a></li>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<div class="video_content">
						...
						<div class="register_button"><a href="register.php">register</a></div>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="teacher d-flex flex-row align-items-center justify-content-start">
						...
						<div class="teacher_content">
							<div class="teacher_name"><a href="instructor_single.php">Aashu Yadav</a></div>
