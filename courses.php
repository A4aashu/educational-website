	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm" class="active"><a href="courses.php">Courses</a></li>
				...
				<li class="menu_mm"><a href="calender.php">Calender</a></li>
			</ul>
		</nav>
					...
					<div class="course">
						...
						<div class="course_body">
							...
							<div class="course_info">
								<ul>
									<li><a href="instructors.php">Anshu priya malviya</a></li>
